...
tuint32 Packets::CG_FIGHT_PAK::Execute( Player* pPlayer )
 ...
 tuint32 Packets::CG_FIGHT_PAK::Execute( ServerPlayer* pServerPlayer )
 {
 __ENTER_FUNCTION
 return CG_FIGHT_PAKHandler::Execute(this,pServerPlayer);
 __LEAVE_FUNCTION
 return PACKET_EXE_ERROR;
 }
//This code create by CodeEngine Author:Wendy ,don't modify
...
tuint32 Packets::CG_LEAVE_COPYSCENE_PAK::Execute( Player* pPlayer )
 ...
 tuint32 Packets::CG_LEAVE_COPYSCENE_PAK::Execute( ServerPlayer* pServerPlayer )
 {
 __ENTER_FUNCTION
 return CG_LEAVE_COPYSCENE_PAKHandler::Execute(this,pServerPlayer);
 __LEAVE_FUNCTION
 return PACKET_EXE_ERROR;
 }
