...
public:
	...
	HANDLEPACKET_USER(::CG_Building_LevelUp);
	HANDLEPACKET_USER(::CG_Troop_Train);
	HANDLEPACKET_USER(::CG_BATTLEPREPARE);
	HANDLEPACKET_USER(::CG_MARCH_MOVE);
	...
	HANDLEPACKET_EMPTY(::GC_Building_LevelUp)
	HANDLEPACKET_EMPTY(::GC_Update_March)
	HANDLEPACKET_EMPTY(::GC_Troop_Train);
	HANDLEPACKET_EMPTY(::GC_TroopTrain_Over);
	HANDLEPACKET_EMPTY(::GC_BATTLEPREPARE);
	HANDLEPACKET_EMPTY(::GC_MARCH_MOVE);
	HANDLEPACKET_EMPTY(::GC_BATTLEEND);
	HANDLEPACKET_EMPTY(::GC_BattleStart);
