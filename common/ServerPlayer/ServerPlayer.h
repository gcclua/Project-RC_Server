...
public:
	...
	HANDLEPACKET_SERVERPLAYER_EMPTY(::CG_FIGHT)
	HANDLEPACKET_SERVERPLAYER_EMPTY(::CG_LEAVE_COPYSCENE)
	HANDLEPACKET_SERVERPLAYER_EMPTY(::CG_ROBOT_OPEN)
	HANDLEPACKET_SERVERPLAYER_EMPTY(::GC_ROBOT_OPEN)

	HANDLEPACKET_SERVERPLAYER_EMPTY(::CG_ASSIGN_HERO)
	HANDLEPACKET_SERVERPLAYER_EMPTY(::GC_ASSIGN_HERO)
	HANDLEPACKET_SERVERPLAYER_EMPTY(::CG_SEND_MARCH)
	HANDLEPACKET_SERVERPLAYER_EMPTY(::GC_SEND_MARCH)
