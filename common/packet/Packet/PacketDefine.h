...
PACKET_CG_MARCH_MOVE_PAK,	//
PACKET_GC_MARCH_MOVE_PAK,	//
...
PACKET_GC_FIGHT_PAK,	//Send Open Fight Ret to client
...
PACKET_CG_BUILDING_LEVELUP_PAK,	// Send Building LevelUp
PACKET_GC_BUILDING_LEVELUP_PAK,	// Ret Building LevelUp
PACKET_GC_UPDATE_MARCH_PAK,	//
PACKET_CG_TROOP_TRAIN_PAK,	// Send Troop Train
PACKET_GC_TROOP_TRAIN_PAK,	//
PACKET_GC_TROOPTRAIN_OVER_PAK,	//
PACKET_CG_BATTLEPREPARE_PAK,	// send arrange change
PACKET_GC_BATTLEPREPARE_PAK,	// ret arrange change to client
PACKET_GC_BATTLEEND_PAK,	// battle end
PACKET_GC_BATTLESTART_PAK,	// battle state
