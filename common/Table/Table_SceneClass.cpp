...
loader.ReadDirect(m_AttackPosX[9],(tint32)ID_ATTACKPOSX10);
loader.ReadDirect(m_AttackPosX[10],(tint32)ID_ATTACKPOSX11);
...
loader.ReadDirect(m_AttackPosZ[9],(tint32)ID_ATTACKPOSZ10);
loader.ReadDirect(m_AttackPosZ[10],(tint32)ID_ATTACKPOSZ11);
...
loader.ReadDirect(m_DefencePosX[9],(tint32)ID_DEFENCEPOSX10);
loader.ReadDirect(m_DefencePosX[10],(tint32)ID_DEFENCEPOSX11);
